...
2. Identify every topic mentioned in the text.
3. Add each topic to a JSON array of strings.
4. Respond with only the JSON array. Do not include any explanation or commentary.
"""
