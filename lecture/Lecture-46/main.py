                ...
                if hasattr(block, "citations") and block.citations:
                    ...
                    for citation in block.citations:
                        if isinstance(citation, dict):
                            doc_title = citation.get("document_title", citation.get("document_index", "Unknown Document"))
                            start_page = citation.get("start_page_number", "N/A")
                            cited_text = citation.get("cited_text", "N/A")
                        else:
                            doc_title = getattr(citation, "document_title", getattr(citation, "document_index", "Unknown Document"))
